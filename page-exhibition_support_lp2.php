...
<div class="service-headline">
	<div class="inner">
		...
		<picture class="mv">
			<source srcset="<?php echo get_template_directory_uri() ?>/images/service/exhibition_support/hero2_sp_sekou.png" media="(max-width: 833px)" />
			<img src="<?php echo get_template_directory_uri() ?>/images/service/exhibition_support/hero2_pc_sekou.png" width="1600" height="650">
		</picture>
		<ul class="page-list text82">
			<?php if (get_field('consultation-form')) : ?>
				<li>
					<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp2#contact" style="border-radius: 99px; box-shadow: 5px 5px 5px 0 rgba(0, 0, 0, 0.3);">
						<dl>
							<dt>お見積り・出展について</dt>
							<dd>「無料相談する」</dd>
						</dl>
...
<script>
	...
	$(function() {
		...
		//規約チェックボックスの文言変更
		$('.accept-box .mwform-checkbox-field-text').html('<a href="<?php echo esc_url(home_url('privacy-policy-lp2/')); ?>" target="_blank" rel="noopener noreferrer" class="underline">プライバシーポリシー</a>に同意する');
	});
</script>