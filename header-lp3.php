...
<body <?php body_class($custom_body_class); ?>>
		...
		<div class="header-inner">
			...
			<nav class="header-navi">
				...
				<ul class="navi-menu txt-serif lp-navi-menu-ul">
					<!-- navi -->
					<li><a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#last-achvm-intro">実績紹介</a></li>
					<li><a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-flow">サービス詳細</a></li>
					<li><a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-comparison">他社サービスとの比較</a></li>
					<li><a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-faq">よくあるご質問</a></li>
					<li class="btn-contact" data-color="white">
						<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#contact">
							<figure class="icon">
	...
	<div id="spNavi" class="tabOnly">
		<ul class="navi-menu txt-serif">
			<li>
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3">ホーム</a>
			</li>
			<li>
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#last-achvm-intro">実績紹介</a>
			</li>
			<li>
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-flow">サービス詳細</a>
			</li>
			<li>
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-comparison">他社サービスとの比較</a>
			</li>
			<li>
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#service-faq">よくあるご質問</a>
			</li>
			<li>
				<a href="<?php echo esc_url(home_url('/privacy-policy-lp3')); ?>">プライバシーポリシー</a>
			</li>
			<li class="navi-contact">
				...
				<a href="<?php echo esc_url(home_url('/service')); ?>/exhibition_support/lp3#contact" class="btn">お問い合わせ</a>
			</li>
		</ul>
	</div>
