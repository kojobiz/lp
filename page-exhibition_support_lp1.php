...
<div class="service-headline">
	<div class="inner">
		...
		<picture class="mv">
			<source srcset="<?php echo get_template_directory_uri() ?>/images/service/exhibition_support/hero1_sp_sousyoku.png" media="(max-width: 833px)" />
			<img src="<?php echo get_template_directory_uri() ?>/images/service/exhibition_support/hero1_pc_sousyoku.png" width="1600" height="650">
		</picture>
			...
			<section class="content contact-area">
				<div class="inner">
					...
					<div class="btn-column">
						<a href="https://ikkosha.co.jp/service/exhibition_support/lp1#contact" class="btn btn01 text80">
	...
	<article class="section-block common-block pd-y_none" data-color="white">
		<section class="content contact-area">
			<div class="inner">
				...
				<div class="btn-column">
					<a href="https://ikkosha.co.jp/service/exhibition_support/lp1#contact" class="btn btn01">
						<img src="<?php echo get_template_directory_uri() ?>/images/common/icon_mail02.png" width="25" height="20" alt="MAIL" class="icon">
						メールでのお問い合わせ
					</a>
...
<script>
	...
	$(function() {
		...
		//規約チェックボックスの文言変更
		$('.accept-box .mwform-checkbox-field-text').html('<a href="<?php echo esc_url(home_url('privacy-policy-lp1/')); ?>" target="_blank" rel="noopener noreferrer" class="underline">プライバシーポリシー</a>に同意する');
	});
</script>